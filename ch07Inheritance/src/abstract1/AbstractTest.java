...
//		b = (ThisClassB)s; 실행할때 오류남
	...
	public static void execute(int a, int b, SuperClass s) {
		if(s instanceof ThisClassA) System.out.println("A");
		if(s instanceof ThisClassB) System.out.println("B");
		if(s instanceof ThisClassC) System.out.println("C");
		if(s instanceof SuperClass) System.out.println("S");
