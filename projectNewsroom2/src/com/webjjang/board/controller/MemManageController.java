...
//					memBoardController.selectMenu(userDTO);
				...
				case "5":
					...
					if (pw.equals(updateUserInfo.getPw())) {
						...
						memManageUtil1.printUserInfo(
								memUpdateService.process(updateUserInfo.getId(), memManageUtil1.update("비밀번호", "pw"),
										memManageUtil1.update("이름", "name"), memManageUtil1.update("닉네임", "nick"),
										memManageUtil1.update("전화번호", "tel"), memManageUtil1.update("이메일", "email")));
